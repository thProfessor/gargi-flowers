...
import audioFile from './auido.mp3'
...
function App() {
  ...
  return (
    <>
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: "#940808", padding: "20px",gap:"10px",minHeight: "100vh",
  maxWidth: "100vw",
  overflow: "hidden",boxSizing:'border-box' }}>
    <motion.div style={{display:"flex",justifyContent:"center",alignItems:"center"}}>
     <motion.h1
      ...
      <Lottie animationData={forgot} style={{ width: "100px", margin: "auto"}} />
      </motion.div>
    <motion.img src={gargi} initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
...
<motion.h4
        ...
        transition={{ duration: 0.6 }}
      >
         PS this was my fav photo and you have a very soulful smile ;)
      </motion.h4>
      <motion.h1
        ...
        {!asked ? (
          <>
            ...
            <div style={{ display: "flex", justifyContent: "space-around", marginTop: "20px" }}>
              ...
              <motion.button
                onClick={() => askOut("I'll take that yes for a coffee then ;)")}
